function [] = MainScript_ultraLight(recordingsFolder, start_dir, end_dir)
...
%end_dir = strcat(recordingsFolder,'Sub20230207002');
...
MI4_trainTestSplit(recordingFolder, trialsForTest);
