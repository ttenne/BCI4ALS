function [] = MainScript_lightRandom_BSFeatures(recordingsFolder, start_dir, end_dir)
...
%start_dir = strcat(recordingsFolder,'Sub20230208001');
%end_dir = strcat(recordingsFolder,'Sub20230208003');
...
MI4_featureExtractionRandom(recordingFolder);
